      ...
      <nav className={classes.header__nav}>
        <Link to="/" className={classes["header__logo--container"]}>
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className={`w-6 h-6 ${classes.header__logo} ${
              props.isAlt ? classes["header__logo--alt"] : ""
            }`}
          >
            <path
              strokeLinecap="round"
          ...
          <h2
            className={`${classes.header__name} ${
              props.isAlt ? classes["header__name--alt"] : ""
            }`}
          >
            ECinema
          </h2>
        ...
        <div className={classes["header__buttons--container"]}>
          ...
          <div
            className={`${classes.header__hamburger} ${
              props.isModalOpen ? classes.open : ""
            }`}
            onClick={() => props.setIsModalOpen(true)}
          >
            {[..."123456789"].map((n) => (
              <div
                className={`${classes["hamburger--dot"]} ${
                  props.isAlt ? classes["header__dot--alt"] : ""
                }`}
                key={n}
              ></div>
            ))}
